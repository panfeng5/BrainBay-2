 /* ----------------------------------------------------------------------------------
  ...
  Co-Authors:
		 Jeremy Wilkerson (Modules: AND, OR, NOT, CORRELATION)
  ...
  Credits: Jim Peters (digital filter works), Jeff Molofee (OpenGL-tutorial)
  		   AllenD (COM-Port control)

  the used non-standard Libraries are:

  Multimedia and OpenGL: winmm.lib opengl32.lib glu32.lib vfw32.lib
  SDL (Simple Direct Media Layer): SDL.lib
